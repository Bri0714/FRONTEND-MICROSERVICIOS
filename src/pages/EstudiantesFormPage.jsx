// src/pages/EstudiantesFormPage.jsx

import React, { useState, useEffect } from 'react';
import { useForm } from 'react-hook-form';
import { useNavigate } from 'react-router-dom';
import { createEstudiante } from '../api/estudiantes'; // Asegúrate de tener esta función API
import { getAllInstituciones } from '../api/instituciones.api';
import { getAllRutas } from '../api/rutas.api';
import { toast } from 'react-hot-toast';
import { Footer } from '../components/footer';

export function EstudiantesFormPage() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                toast.error('Error al cargar instituciones y rutas', {
    ...
    const onSubmit = async (data) => {
        if (currentStep === 1) {
            ...
            try {
                ...
                // Agregar datos del Acudiente con dot notation
                formData.append('acudiente.acudiente_nombre', acudienteData.acudiente_nombre);
                formData.append('acudiente.acudiente_apellido', acudienteData.acudiente_apellido);
                formData.append('acudiente.acudiente_parentesco', acudienteData.acudiente_parentesco);
                formData.append('acudiente.acudiente_telefono', acudienteData.acudiente_telefono);
                ...
                >
                    ...
                    {currentStep === 2 && (
                        <>
                            ...
                            {/* Botones "Atrás" y "Guardar Estudiante" */}
